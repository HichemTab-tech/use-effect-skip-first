# 👥 Contributing to use-effect-skip-first
...
- Browse [existing issues](https://github.com/HichemTab-tech/use-effect-skip-first/issues) to see if your issue or feature idea has already been raised.
- If your idea or issue hasn't been addressed, feel free to [create a new issue](https://github.com/HichemTab-tech/use-effect-skip-first/issues/new).
...
2. Clone your forked repository:
    ...
    ```sh
    git clone https://github.com/YOUR_GITHUB_USERNAME/use-effect-skip-first
    cd use-effect-skip-first
    ```
